...
def resource_path(relative_path):
    ...
    try:
        ...
        # Se não estiver empacotado, o caminho base é o diretório atual
        base_path = os.path.abspath(".")

    return os.path.join(base_path, relative_path)

# AGORA USAMOS A FUNÇÃO PARA DEFINIR O CAMINHO CORRETO
NOME_BANCO_DADOS = resource_path('espetao.db')
